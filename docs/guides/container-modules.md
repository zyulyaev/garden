...
Very similar to the above example, you can also mount ConfigMaps on Kubernetes using the [`configmap` module type](../reference/module-types/configmap.md), supported by the `kubernetes` provider. Here's a simple example:
